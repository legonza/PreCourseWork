...
function countingCharacters3(str, search){
	...
	/* we need to stop loop based on multiple characters example: if searching "Ohio" with 3 characters at a time we want to stop at h so we do not past the end of the string */
